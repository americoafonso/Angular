...
export class LancamentoService {
  ...
  atualizar(lancamento: Lancamento): Promise<Lancamento> {
    ...
    .toPromise().then(response => {
      ...
      this.converterStringPorData([lancamentoAlterado]);
  ...
  buscarPorCodigo(codigo: number): Promise<Lancamento> {
    ...
    return this.http.get<Lancamento>(`${this.lancamentosUrl}/${codigo}`, { headers }).toPromise().then(response => {
      const lancamento = response;

      this.converterStringPorData([lancamento]);
  ...
  private converterStringPorData(lancamentos: Lancamento[]) {
